...
static GVariant *
dfsm_ast_statement_throw_execute (DfsmAstStatement *statement, DfsmEnvironment *environment, GError **error)
{
	...
	g_dbus_error_set_dbus_error (error, priv->error_name, message, NULL);
	g_free (message);
